...
renderGraphiql(document.body)
`

const graphiql_template = `
<!DOCTYPE html>
...
<head>
  ...
  <meta name="keywords" content="golang,graphql,relay,react,graphiql" />
...
Loading...
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/graphiql/0.3.1/graphiql.min.js"></script>
  <style>` + app_css + `</style>
